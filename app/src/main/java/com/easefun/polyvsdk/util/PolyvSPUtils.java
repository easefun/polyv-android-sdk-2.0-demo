...
public final class PolyvSPUtils {

    private static SimpleArrayMap<String, PolyvSPUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
    private SharedPreferences sp;

    /**
     * 获取 SP 实例
     *
     * @return {@link PolyvSPUtils}
     */
    public static PolyvSPUtils getInstance(Context context) {
     ...
     * @return {@link PolyvSPUtils}
     */
    public static PolyvSPUtils getInstance(Context context, String spName) {
        if (isSpace(spName)) spName = "PolyvSPUtils";
        PolyvSPUtils PolyvSPUtils = SP_UTILS_MAP.get(spName);
        if (PolyvSPUtils == null) {
            PolyvSPUtils = new PolyvSPUtils(context, spName);
            SP_UTILS_MAP.put(spName, PolyvSPUtils);
        }
        return PolyvSPUtils;
    }

    private PolyvSPUtils(Context context, final String spName) {
