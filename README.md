...
[![GitHub release](https://img.shields.io/badge/release-v2.7.3-blue.svg)](https://github.com/easefun/polyv-android-sdk-2.0-demo/releases/tag/v2.7.3)
...
2.7.4版API文档请看[v2.7.4 API](http://repo.polyv.net/android/sdk/2.7.4/api/index.html)
