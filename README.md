...
[![GitHub release](https://img.shields.io/badge/release-v2.4.0-blue.svg)](https://github.com/easefun/polyv-android-sdk-2.0-demo/releases/tag/v2.4.0)
...
2.4.0版API文档请看[v2.3.3 API](http://repo.polyv.net/android/sdk/2.3.3/api/index.html)