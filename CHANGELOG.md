...
API文档请看 [v2.28.0 API](http://repo.polyv.net/android/sdk/2.28.0/api/index.html)

### 2026-08-28 polyv-android-sdk-2.0.0-demo v2.27.3

### 功能完善&bug修复
* 自定义token需兼容有效次数以及过期时间
* 完善SDK内部日志上报信息
...
API文档请看 [v2.27.3 API](http://repo.polyv.net/android/sdk/2.27.3/api/index.html)

### 2026-07-17 polyv-android-sdk-2.0.0-demo v2.27.2

### 功能完善&bug修复
* Demo 播放、下载默认使用token
* 修改默认的截图大小，避免半屏播放的截图模糊
* 优化SDK内部日志上报格式
...
API文档请看 [v2.27.2 API](http://repo.polyv.net/android/sdk/2.27.2/api/index.html)
...
API文档请看 [v2.27.1 API](http://repo.polyv.net/android/sdk/2.27.1/api/index.html)
...
API文档请看 [v2.27.0 API](http://repo.polyv.net/android/sdk/2.27.0/api/index.html)

### 2026-03-13 polyv-android-sdk-2.0.0-demo v2.26.0

### 功能完善&bug修复
* 适配16kb page size
* 适配Android15 & Android16
...
API文档请看 [v2.26.0 API](http://repo.polyv.net/android/sdk/2.26.0/api/index.html)
...
API文档请看 [v2.25.2 API](http://repo.polyv.net/android/sdk/2.25.2/api/index.html)
